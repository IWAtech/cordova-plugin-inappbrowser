...
- (void)createViews
{
    ...
    BOOL toolbarIsAtBottom = NO; //![_browserOptions.toolbarposition isEqualToString:kInAppBrowserToolbarBarPositionTop];
    ...
    UIColor *bgColor = [UIColor colorWithRed:51.0/255.0 green:51.0/255.0 blue:51.0/255.0 alpha:1.0];
